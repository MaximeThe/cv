...
const getBundleModulesByChunk = (chunkIds, chunkId, fileType = '') => ({
    ...
    params: {
        [component_links_1.COMPONENT.BUNDLE_MODULES]: {
            filters: {
                [component_links_1.MODULE_FILTERS.CHANGED]: true,
...
const getBundleAssetsFileTypeComponentLink = (fileType, label) => ({
    section: component_links_1.SECTIONS.ASSETS,
    title: (0, template_1.default)(i18n_1.default.COMPONENT_LINK_BUNDLE_ASSETS_BY_FILE_TYPE)({ label }),
    params: {
        [component_links_1.COMPONENT.BUNDLE_ASSETS]: {
            filters: {
                ...(0, exports.getAssetFileTypeFilters)(false),
...
const getComponentStateQueryString = (params = {}) => {
    ...
    return (0, query_string_1.stringify)((0, serialize_query_params_1.encodeQueryParams)(meta, params));
};
